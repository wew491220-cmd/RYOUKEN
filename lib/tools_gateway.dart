...
final Color primaryDark   = const Color(0xFF0A0E27); // tetap (background bagus)
final Color primaryBlue   = const Color(0xFF6A1B9A); // violet lebih bold (biar kelihatan)
final Color accentBlue    = const Color(0xFF8E24AA); // violet neon
final Color lightBlue     = const Color(0xFFCE93D8); // glow soft
final Color primaryWhite  = Colors.white;
final Color accentGrey    = Colors.grey.shade400;
final Color cardDark      = const Color(0xFF151937); // tetap cocok
