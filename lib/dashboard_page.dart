...
class _DashboardPageState extends State<DashboardPage>
  ...
  // Warna tema hitam violet
final Color primaryDark        = Color(0xFF0A0E27);
final Color primaryBlue        = Color(0xFF5E35B1); // violet utama
final Color accentBlue         = Color(0xFF7E57C2); // violet terang
final Color lightBlue          = Color(0xFFB39DDB); // violet soft
final Color primaryWhite       = Colors.white;
final Color accentGrey         = Colors.grey.shade400;
final Color cardDark           = Color(0xFF151932);
final Color cardDarker         = Color(0xFF0F1330);

// 🔥 INI YANG PALING PENTING (biang biru di dashboard)
final Color blueGradientStart  = Color(0xFF5E35B1); // ganti violet
final Color blueGradientEnd    = Color(0xFF9575CD); // violet lebih terang
