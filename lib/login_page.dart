...
const String baseUrl = "http://panel-private-alzz.mypanelserver.biz.id:4000";
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          if (showContact)
            TextButton(
              onPressed: () async {
                await launchUrl(Uri.parse("https://t.me/AlzzMods"),
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF1A0933), Color(0xFF12082A), Color(0xFF1A0933)],
                  ...
                  return Transform.rotate(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: Color(0xFF8E24AA).withOpacity(0.15),
                          width: 2,
                        ),
                      ),
                    ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          gradient: LinearGradient(
                            colors: [Color(0xFF7E57C2), Color(0xFF8E24AA)],
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
                          ),
                          boxShadow: [
                            BoxShadow(
                              color: Color(0xFF8E24AA).withOpacity(0.6),
                              blurRadius: 15,
                              spreadRadius: 2,
                            ),
                          ],
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: Color(0xFF8E24AA).withOpacity(0.8)),
